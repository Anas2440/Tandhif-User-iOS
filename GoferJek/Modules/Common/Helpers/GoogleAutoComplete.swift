...
//        self.currentLong = nil
    ...
    func getAutoComplete(for searchText : String){
        ...
        //        guard let url = URL(string: "https://maps.googleapis.com/maps/api/place/autocomplete/json?key=\(AppWebConstants.GoogleApiKey)&input=\(searchText)\(locationSurroundingPreference)") else{return}
        ////
        ...
        ConnectionHandler.shared.getRequest(forAPI: "https://maps.googleapis.com/maps/api/place/autocomplete/json",
                                            params: params, CacheAttribute: .none)
