...
class NetworkManager{
    ...
    private func initToastLable(){
        ...
        toastLabel?.font = UIFont(name: G_MediumFont, size: CGFloat(15))
...
//       }
        ...
        guard let window = UIApplication.shared.connectedScenes.compactMap({ $0 as? UIWindowScene }).flatMap{ $0.windows }.filter({ $0.isKeyWindow }).first else{ return }
