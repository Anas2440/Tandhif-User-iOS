...
class ProfileModel : NSObject {
    ...
    func store(){
        ...
        Constants().STOREVALUE(value: self.getUserName, keyname: USER_FULL_NAME)
        ...
        Constants().STOREVALUE(value: self.phone, keyname: USER_PHONE_NUMBER)
        Constants().STOREVALUE(value: self.countryModel.dial_code, keyname: USER_DIAL_CODE)
