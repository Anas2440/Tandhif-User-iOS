...
@class CXProvider;
@class SINWebRtcCallConfiguration;
 ...
 */
@property (atomic, weak) id<SINCallClientDelegate> delegate;
...
/**
 * Sets the WebRTC configuration for every call created by SINCallClient. This method must be invoked before
 * initiating any outgoing call or relying the push payload to ensure the configuration is applied.
 *
 * @param webRtcCallConfiguration The configuration to be used for WebRTC calls.
 */
- (void)setWebRtcCallConfiguration:(SINWebRtcCallConfiguration *)webRtcCallConfiguration;
