...
class HandyCheckOutBookingView: BaseView {
    ...
    func initPaymentView(){
        ...
        self.changePaymentView.walletStack.isHidden = !(
            Constants().GETVALUE(keyname: "selectwallet") == "Yes"
                && !walletAmount.toDouble().isZero)
        print("isWallet : \(self.changePaymentView.walletStack.isHidden)",Constants().GETVALUE(keyname: "selectwallet"))
        self.changePaymentView.promoStack.isHidden = !(
            Constants().GETVALUE(keyname: "Promo_Code") != "0"
                && Constants().GETVALUE(keyname: "Promo_Code") != "")
