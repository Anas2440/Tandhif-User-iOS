...
class RiderDatasModel : NSObject {
...
//        self.paypal_mode = copy.paypal_mode
    ...
    func update(fromData data : RiderDatasModel){
    ...
    func storeRiderBasicDetail(){
        ...
        Constants().STOREVALUE(value: self.arraycount, keyname: "Promo_Code")
        Constants().STOREVALUE(value: self.user_name, keyname: "full_name")
        ...
        Constants().STOREVALUE(value: self.mobile_number, keyname: "phonenumber")
        Constants().STOREVALUE(value: self.country_code, keyname: "user_country_code")
        Constants().STOREVALUE(value: self.home_location_name, keyname: "home_loc")
        Constants().STOREVALUE(value: self.work_location_name, keyname: "work_loc")
        Constants().STOREVALUE(value: self.home_location_latitude, keyname: "home_latitude")
        Constants().STOREVALUE(value: self.home_location_longitude, keyname: "home_longitude")
        Constants().STOREVALUE(value: self.work_location_latitude, keyname: "work_latitude")
        Constants().STOREVALUE(value: self.work_location_longitude, keyname: "work_longitude")
       // Constants().STOREVALUE(value: self.gender, keyname: USER_GENDER)
    }
    func storeRiderImprotantData(){
        
        if !self.access_token.isEmpty{
            Constants().STOREVALUE(value: self.access_token, keyname: "access_token")
        }
        if !self.user_id.isEmpty{
            Constants().STOREVALUE(value: self.user_id, keyname: "user_id")
        }
        Constants().STOREVALUE(value: self.paypal_email_id, keyname: "paypal_email_id")
        Constants().STOREVALUE(value: self.wallet_amount, keyname: "wallet_amount")
