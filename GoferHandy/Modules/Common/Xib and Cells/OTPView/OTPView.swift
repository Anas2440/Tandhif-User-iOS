...
class DeleteTextField :UITextField {
    ...
    func customColorsUpdate(){
        self.backgroundColor = self.isDarkStyle ? .DarkModeBackground : .SecondaryTextColor
...
class OTPView: UIView {
    ...
    func ThemeChange() {
        self.tf1.backgroundColor = self.isDarkStyle ? .DarkModeBackground : .SecondaryColor
        self.tf1.textColor = self.isDarkStyle ? .DarkModeTextColor : .SecondaryTextColor
        self.tf2.backgroundColor = self.isDarkStyle ? .DarkModeBackground : .SecondaryColor
        self.tf2.textColor = self.isDarkStyle ? .DarkModeTextColor : .SecondaryTextColor
        self.tf3.backgroundColor = self.isDarkStyle ? .DarkModeBackground : .SecondaryColor
        self.tf3.textColor = self.isDarkStyle ? .DarkModeTextColor : .SecondaryTextColor
        self.tf4.backgroundColor = self.isDarkStyle ? .DarkModeBackground : .SecondaryColor
        self.tf4.textColor = self.isDarkStyle ? .DarkModeTextColor : .SecondaryTextColor
    }
