...
struct ImageConstants {
    lazy var phone : String = {"phone"}()
    lazy var account : String = {"account"}()
    lazy var mapMarker : String = {"map_marker"}()
    lazy var clockOutline : String = {"clock_outline"}()
    lazy var busIcon : String = {"bus_alert"}()
}
