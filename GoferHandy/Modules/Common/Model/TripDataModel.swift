...
//        let pickupImgUrl = String(format:"%@public/images/pickup_icon|",AppWebConstants.baseURL)
//        let dropImgUrl = String(format:"%@public/images/dropoff_icon|",AppWebConstants.baseURL)
