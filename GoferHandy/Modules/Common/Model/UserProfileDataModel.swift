...
class UserProfileDataModel: Codable {
    ...
    func storeRiderBasicDetail(){
        ...
        Constants().STOREVALUE(value: self.promoDetails.count.description, keyname: "Promo_Code")
        Constants().STOREVALUE(value: self.userName, keyname: "full_name")
        Constants().STOREVALUE(value: self.firstName, keyname: "first_name")
        Constants().STOREVALUE(value: self.lastName, keyname: "last_name")
        Constants().STOREVALUE(value: self.profileImage, keyname: "user_image")
        Constants().STOREVALUE(value: self.emailID, keyname: "user_email_id")
        Constants().STOREVALUE(value: self.mobileNumber, keyname: "phonenumber")
        Constants().STOREVALUE(value: self.countryCode, keyname: "user_country_code")
        Constants().STOREVALUE(value: self.home, keyname: "home_loc")
        Constants().STOREVALUE(value: self.work, keyname: "work_loc")
        Constants().STOREVALUE(value: self.homeLatitude, keyname: "home_latitude")
        Constants().STOREVALUE(value: self.homeLongitude, keyname: "home_longitude")
        Constants().STOREVALUE(value: self.workLatitude, keyname: "work_latitude")
        Constants().STOREVALUE(value: self.workLongitude, keyname: "work_longitude")
    ...
    func storeRiderImprotantData(){
        ...
        if !self.accessToken.isEmpty{
            Constants().STOREVALUE(value: self.accessToken, keyname: "access_token")
        }
        if !(self.userID == 0){
            Constants().STOREVALUE(value: self.userID.description, keyname: "user_id")
        }
        Constants().STOREVALUE(value: self.paypalEmailID, keyname: "paypal_email_id")
        Constants().STOREVALUE(value: self.walletAmount, keyname: "wallet_amount")
