...
//        }else{
//            duration = "\(self.arrivalTime) \(LangCommon.mins.capitalized)"
//        }
//        return duration
//    }
...
//        self.rating = riderJSON.string("rating")
//        self.contact = riderJSON.string("contact")
//
//
//        UserDefaults.set(self.driverId, for: .driver_"user_id")
...
//        }else{
//            UserDefaults.removeValue(for: .driver_"user_id")
