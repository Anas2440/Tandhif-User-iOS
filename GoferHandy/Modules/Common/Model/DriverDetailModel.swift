...
//        let time = LangGofer.minArrivalTillStart
//        let fee = LangGofer.minWaitingApplied
...
//        UserDefaults.set(self.driver_id, for: .driver_"user_id")
...
//        let key = "&key=" +  AppWebConstants.GoogleApiKey//(UserDefaults.value(for: .google_api_key) ?? "")
//        let pickupImgUrl = String(format:"%@public/images/pickup_icon|",AppWebConstants.APIBaseUrl)
//        let dropImgUrl = String(format:"%@public/images/dropoff_icon|",AppWebConstants.APIBaseUrl)
...
//            Constants().STOREVALUE(value: json.string("wallet_amount"), keyname: "wallet_amount")
